...
def run(playwright: Playwright) -> None:
    ...
    # Open login page
    page.goto("http://13.235.198.88/focus8w/", timeout=120000)  # 120 seconds
    ...
    page.wait_for_selector("#txtPassword", timeout=60000)
    ...
    page.get_by_role("textbox", name="Menu Search",timeout=50000).click()
